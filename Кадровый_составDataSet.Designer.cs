...
namespace Form9 {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("Кадровый_составDataSet")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class Кадровый_составDataSet : global::System.Data.DataSet {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        protected Кадровый_составDataSet(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            Кадровый_составDataSet cln = ((Кадровый_составDataSet)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "Кадровый_составDataSet";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/Кадровый_составDataSet.xsd";
        ...
        public static global::System.Xml.Schema.XmlSchemaComplexType GetTypedDataSetSchema(global::System.Xml.Schema.XmlSchemaSet xs) {
            Кадровый_составDataSet ds = new Кадровый_составDataSet();
        ...
        public partial class ДолжностиDataTable : global::System.Data.TypedTableBase<ДолжностиRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ДолжностиRow AddДолжностиRow(string НаименованиеДолжности) {
...
namespace Form9.Кадровый_составDataSetTableAdapters {
    ...
    public partial class ДолжностиTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Должности` WHERE ((`КодДолжности` = ?) AND ((? = 1 AND `Наименование" +
                "Должности` IS NULL) OR (`НаименованиеДолжности` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Должности` (`НаименованиеДолжности`) VALUES (?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Должности` SET `НаименованиеДолжности` = ? WHERE ((`КодДолжности` = ?) AN" +
                "D ((? = 1 AND `НаименованиеДолжности` IS NULL) OR (`НаименованиеДолжности` = ?))" +
                ")";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Form9.Properties.Settings.Default.Кадровый_составConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT КодДолжности, НаименованиеДолжности FROM Должности";
        ...
        public virtual int Fill(Кадровый_составDataSet.ДолжностиDataTable dataTable) {
        ...
        public virtual Кадровый_составDataSet.ДолжностиDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Кадровый_составDataSet.ДолжностиDataTable dataTable = new Кадровый_составDataSet.ДолжностиDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Кадровый_составDataSet.ДолжностиDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Кадровый_составDataSet dataSet) {
        ...
        public virtual int Delete(int Original_КодДолжности, string Original_НаименованиеДолжности) {
        ...
        public virtual int Insert(string НаименованиеДолжности) {
        ...
        public virtual int Update(string НаименованиеДолжности, int Original_КодДолжности, string Original_НаименованиеДолжности) {
            if ((НаименованиеДолжности == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(Original_КодДолжности));
            if ((Original_НаименованиеДолжности == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(Original_НаименованиеДолжности));
            }
    ...
    public partial class СотрудникиTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Сотрудники` WHERE ((`КодСотрудника` = ?) AND ((? = 1 AND `Фамилия` IS NULL) OR (`Фамилия` = ?)) AND ((? = 1 AND `Имя` IS NULL) OR (`Имя` = ?)) AND ((? = 1 AND `Отчество` IS NULL) OR (`Отчество` = ?)) AND ((? = 1 AND `КодДолжности` IS NULL) OR (`КодДолжности` = ?)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Сотрудники` (`Фамилия`, `Имя`, `Отчество`, `КодДолжности`) VALUES (?" +
                ", ?, ?, ?)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Сотрудники` SET `Фамилия` = ?, `Имя` = ?, `Отчество` = ?, `КодДолжности` = ? WHERE ((`КодСотрудника` = ?) AND ((? = 1 AND `Фамилия` IS NULL) OR (`Фамилия` = ?)) AND ((? = 1 AND `Имя` IS NULL) OR (`Имя` = ?)) AND ((? = 1 AND `Отчество` IS NULL) OR (`Отчество` = ?)) AND ((? = 1 AND `КодДолжности` IS NULL) OR (`КодДолжности` = ?)))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT КодСотрудника, Фамилия, Имя, Отчество, КодДолжности FROM Сотрудники";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(Кадровый_составDataSet.СотрудникиDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual Кадровый_составDataSet.СотрудникиDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Кадровый_составDataSet.СотрудникиDataTable dataTable = new Кадровый_составDataSet.СотрудникиDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Кадровый_составDataSet.СотрудникиDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_КодСотрудника, string Original_Фамилия, string Original_Имя, string Original_Отчество, global::System.Nullable<int> Original_КодДолжности) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string Фамилия, string Имя, string Отчество, global::System.Nullable<int> КодДолжности) {
            if ((Фамилия == null)) {
                this.Adapter.InsertCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Фамилия, string Имя, string Отчество, global::System.Nullable<int> КодДолжности, int Original_КодСотрудника, string Original_Фамилия, string Original_Имя, string Original_Отчество, global::System.Nullable<int> Original_КодДолжности) {
            if ((Фамилия == null)) {
                this.Adapter.UpdateCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Original_КодСотрудника));
            if ((Original_Фамилия == null)) {
            ...
            if ((Original_КодДолжности.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[12].Value = ((int)(Original_КодДолжности.Value));
            }
            else {
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateUpdatedRows(Кадровый_составDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._должностиTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateInsertedRows(Кадровый_составDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._должностиTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateDeletedRows(Кадровый_составDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._сотрудникиTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        public virtual int UpdateAll(Кадровый_составDataSet dataSet) {
            if ((dataSet == null)) {
